...
число evidence claims и, для fallback, безопасную категорию ошибки и выбранный
pool/template. Полный prompt,
исходные facts, ответ с reasoning и текст ошибки провайдера в provenance не
копируются. Новые записи используют provenance v2; v1 остаётся читаемой.
