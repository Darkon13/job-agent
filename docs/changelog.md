...
- Dashboard: у откликов из «Нужно участие» появилась ссылка «Открыть анкету» —
  она ведёт сразу на страницу анкеты вакансии на HH; после заполнения рядом
  есть «Повторить», который возвращает отклик в работу.
