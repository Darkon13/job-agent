...
интерактивный вход, поиск, рассылки откликов, сопроводительные, живое
...
- [ ] DoD: создание резюме из bootstrap-файла (`1.0.x`) и безопасный update с
      publish (готов).
- [ ] `1.0.x`: расширенный tailoring (about/experience/теги из вакансии через
      модель), ежедневный `resume.rewrite` и обезличенный контекст модели с
      плейсхолдерами для сопроводительных.
