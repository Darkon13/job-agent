...
const (
	...
	EventConversationMessageQueued     EventType = "conversation.message_queued"
	EventConversationMessageSent       EventType = "conversation.message_sent"
	EventConversationMessageFailed     EventType = "conversation.message_failed"
	EventConversationMarkedRead        EventType = "conversation.marked_read"
	EventConversationFollowUpScheduled EventType = "conversation.follow_up_scheduled"
	EventConversationFollowUpCancelled EventType = "conversation.follow_up_cancelled"
